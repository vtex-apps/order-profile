📢 Use this project, [contribute](https://github.com/vtex-apps/order-profile) to it or open issues to help evolve it using [Store Discussion](https://github.com/vtex-apps/store-discussion).
